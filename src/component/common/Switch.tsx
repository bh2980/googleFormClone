  ...
  return (
    <label className="flex gap-4" tabIndex={0}>
      ...
      <div className="relative flex items-center cursor-pointer w-[48px] h-[24px]">
        ...
        <span className="absolute h-[24px] w-[24px] bg-gray-100 shadow-md rounded-full peer-checked:bg-violet-500 peer-checked:translate-x-[100%] hover:ring-8 hover:ring-gray-300/50 peer-checked:hover:ring-violet-400/50" />
      </div>
